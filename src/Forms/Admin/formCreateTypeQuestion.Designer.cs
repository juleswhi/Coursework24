...
partial class formCreateTypeQuestion
{
    /// <summary>
    ...
    private void InitializeComponent()
    {
        ...
        btnCreatePuzzle.Location = new Point(541, 376);
        btnCreatePuzzle.Name = "btnCreatePuzzle";
        btnCreatePuzzle.Size = new Size(119, 62);
        btnCreatePuzzle.TabIndex = 8;
        btnCreatePuzzle.Text = "Create Question";
